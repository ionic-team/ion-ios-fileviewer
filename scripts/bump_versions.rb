...
podspec_path = "./IONFileViewerLib.podspec"
...
new_readme_content = readme_content.gsub(/(pod 'IONFileViewerLib', '~> )\d+\.\d+\.\d+/, "\\1#{new_version_number}\\2")
